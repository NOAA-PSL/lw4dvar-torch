...
# This script lives in backends/aifs/, but long_window_4dvar_utils.py
# lives at the repo root -- running it as `python backends/aifs/
# aifs_prefetch_ic.py` sets sys.path[0] to backends/aifs/ (Python's
